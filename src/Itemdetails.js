        ...
        <div className="items">
          ...
          <div className="test">
            ...
            <div className="items__icons">
              ...
              <h3>Клиенто орейтированность</h3>
            </div>
            <h4 style={{ paddingLeft: "41px", width: "70%" }}>
              Всегда на связи и помогают с проблемами
            </h4>
            <br />
            <div className="items__icons">
              <svg
            ...
            <h4 style={{ paddingLeft: "41px", width: "70%" }}>
              Вы можете бронировать и отменять бронь легко и просто
            </h4>
            <br />
            <hr />
            ...
            <button className="items__btn">Все услуги</button>
            <hr />
            <h2 style={{ padding: "25px 0" }}>Локация</h2>
            <h3 style={{ textDecoration: "none" }}>
              {items.location}, Казахстан.
            </h3>
            <button className="items__btn">Полный адрес</button>
