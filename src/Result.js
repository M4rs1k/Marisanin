    ...
    return (
      <div>
        ...
        <div className="result">
          <h4>{this.state.resultcontent.length} Ночей</h4>
          <h2>Сортировать варианты:</h2>
          <button>Дешевый к дорогому</button>
          <button>Дорогой к дешевому</button>
          <button>Количество комнат</button>
          <button>Больше филтров...</button>
        </div>
